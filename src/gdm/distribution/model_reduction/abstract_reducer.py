...
class LumpedComponent(BaseModel):
    ...
    capacitor_kvar: dict[Phase, float] =  {Phase.A : 0, Phase.B : 0, Phase.C : 0, Phase.S1 : 0, Phase.S2 : 0}
    solar_kw : float =  0
...
class AbstractReducer(ABC):
        ...
        return DistributionSolar(
            ...
            equipment=SolarEquipment(
                ...
                rated_capacity=PositiveActivePower(
                    lumped_generator.solar_kw, "kilowatt"
                ),
    ...
    def _build_reduced_network_skeleton(self, reduced_system:DistributionSystem, primary_network: nx.Graph) -> DistributionSystem:
