...
class SurgeArrester(BaseEquipment):
    ...
    mounting_type_LV: Annotated[MountingTypesLVSwitch | None, Field(description="Mounting type of the LV surge arrester")]
    mounting_type_MV: Annotated[MountingTypesMVSwitch | None, Field(description="Mounting type of the MV surge arrester")]
...
class BaseSurgeArrester(Component):
    electrical_properties: None
    physical_properties: Annotated[SurgeArrester | None , Field(description="Physical properties of the surge arrester")]